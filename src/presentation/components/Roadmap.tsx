...
const phases = [
  ...
  },
  {
    ...
    items: [
      "Mandatory onboarding: Create → Name → Goal → Context → Dashboard",
      "Workspace Pulse + Decision Report (why, risks, next actions)",
      "Simulation detail: multi-future comparison, choose/save path, export",
      "Timeline cards: Goal → Future A ⭐ → B → C",
      "Primary nav: Dashboard · Knowledge · Simulations · Timeline · Settings",
      "Knowledge library + dual-write persistence (local + Supabase)",
    ],
  },
  {
    num: "Phase 03",
